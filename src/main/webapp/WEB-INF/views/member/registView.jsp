                    ...
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <form:form modelAttribute="member" action="/registDo" method="post" >
                            ...
                            <div class="form-floating mb-3">
                                <form:input path="memId" name="memId" class="form-control" id="id" type="text" placeholder="아이디를 입력해주세요."/>
                                <form:errors path="memId" cssClass="error" />
                                <label for="id">ID</label> 
                            </div>
                            <!-- Pw address input-->
                            <div class="form-floating mb-3">
                                <form:input path="memPw" name="memPw" class="form-control" id="pw"  type="password" placeholder="비밀번호를 입력해주세요."/>
                                <form:errors path="memPw" cssClass="error" />
                                <label for="pw">Password</label>   
                            </div>
                            <!-- Nm input-->
                            <div class="form-floating mb-3">
                                <form:input path="memNm" name="memNm" class="form-control" id="name" type="text" placeholder="이름을 입력해주세요."/>
